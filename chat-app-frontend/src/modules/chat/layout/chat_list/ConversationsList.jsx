        ...
        <div className="d-flex flex-column h-100">
            ...
            <div className="p-3 pb-2">
                ...
                <InputGroup className="mb-3">
                    <InputGroup.Text className="bg-light border-end-0 text-muted search-icon">
                        <FaSearch />
                    </InputGroup.Text>
                    <Form.Control
                        placeholder="Search"
                        className="bg-light border-start-0 shadow-none text-muted search-input"
                        value={searchTerm}
            ...
            <div className="flex-grow-1 overflow-auto px-2">
                {filteredConversations.map((convo) => (
                    <div
                        ...
                        className={`d-flex align-items-center p-3 mb-2 rounded-3 cursor-pointer transition-colors conversation-item ${selectedId === convo.id ? 'active' : 'hover-bg-light'}`}
                    >
                        {/* Avatar */}
                        <div className="me-3 position-relative">
                            {convo.user.avatar && !convo.user.avatar.includes('via.placeholder') ? (
                                <img
                                    ...
                                    alt={convo.user.name}
                                    className="rounded-circle object-fit-cover avatar-48"
                                />
                            ) : (
                                <div
                                    className="rounded-circle bg-secondary d-flex align-items-center justify-content-center text-white avatar-48"
                                >
                        ...
                        <div className="flex-grow-1 overflow-hidden">
                            <div className="d-flex justify-content-between align-items-baseline mb-1">
                                ...
                                <small className="text-muted ms-2 time-text">{convo.time}</small>
                            </div>
